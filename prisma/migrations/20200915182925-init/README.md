# Migration `20200915182925-init`

This migration has been generated by Anders Nylund at 9/15/2020, 9:29:25 PM.
...
ALTER TABLE "public"."folders" ADD FOREIGN KEY ("user_id")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."clips" ADD FOREIGN KEY ("user_id")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."clips" ADD FOREIGN KEY ("folder_id")REFERENCES "public"."folders"("id") ON DELETE SET NULL ON UPDATE CASCADE
```
