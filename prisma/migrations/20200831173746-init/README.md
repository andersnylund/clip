# Migration `20200831173746-init`

This migration has been generated by Anders Nylund at 8/31/2020, 8:37:46 PM.
...
ALTER TABLE "public"."Folder" ADD FOREIGN KEY ("userId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."Bookmark" ADD FOREIGN KEY ("userId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."Bookmark" ADD FOREIGN KEY ("folderId")REFERENCES "public"."Folder"("id") ON DELETE SET NULL ON UPDATE CASCADE
```
